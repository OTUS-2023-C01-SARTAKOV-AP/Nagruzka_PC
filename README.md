...
В данном разделе выложен итоговый проект №2 (второй из двух сдаваемых в декабре 2023) 
...
"Оптимизация производительности БД PostgreSQL путём автоматического распараллеливания задач" он идет под №1) и он так же реализован.

**Минус - проект №1 должен располагаться на ноутбуке**. 

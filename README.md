...
В принципе - особых сложностей не было, т.к. с БД уже хорошо и плотно работал более 5 лет. С HTML версткой работал уже лет 20. С Питоном года 4. \
Сам проект на Си имеет довольно таки простую структуру и никаких заковырок не имеет. Чего не скажешь об основном проекте №1 =  
<a href="https://github.com/OTUS-2023-C01-SARTAKOV-AP/proekt_mmvb_analiz" title="Ускорение работы БД">Ускорение работы БД.</a> \

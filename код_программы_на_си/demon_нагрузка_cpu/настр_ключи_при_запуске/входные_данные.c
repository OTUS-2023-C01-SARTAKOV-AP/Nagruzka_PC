...
{   
    ...
    " \n" 
    " Как пример запуск программы из папки, в которой расположен файл запуска:\n"
    "./nagruzka_pc_log_indb -db test_si_2023 -schema db_log -table нагрузка_системы -host localhost -port 5432 -user postgres -psw 11111 -log_path /home/postgres/z_mmvb_temp/z_test.log -delay 3  -test 2"
    "\n"
